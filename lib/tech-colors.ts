...
export const techColors: Record<string, string> = {
  ...
  'PowerShell': 'bg-indigo-100 text-indigo-900 dark:bg-indigo-950/70 dark:text-indigo-200 border border-indigo-200 dark:border-indigo-800',
  ...
  'Active Directory': 'bg-purple-100 text-purple-900 dark:bg-purple-950/70 dark:text-purple-200 border border-purple-200 dark:border-purple-800',
  
  // Tools & Services
  'Bitbucket': 'bg-sky-100 text-sky-900 dark:bg-sky-950/70 dark:text-sky-200 border border-sky-200 dark:border-sky-800',
  'Bamboo': 'bg-lime-100 text-lime-900 dark:bg-lime-950/70 dark:text-lime-200 border border-lime-200 dark:border-lime-800',
  'Web Scraping': 'bg-red-100 text-red-900 dark:bg-red-950/70 dark:text-red-200 border border-red-200 dark:border-red-800',
  'Text Processing': 'bg-indigo-100 text-indigo-900 dark:bg-indigo-950/70 dark:text-indigo-200 border border-indigo-200 dark:border-indigo-800',
};
...
export function getTechColor(tech: string): string {
  return techColors[tech] || 'bg-muted/50 text-muted-foreground border border-border hover:bg-muted/80 transition-colors';
}
